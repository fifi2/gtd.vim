...
syntax match gtdResultsResult /^\zs\d\{8}_\d\{6} .*$/ contains=gtdResultsResultKey,gtdResultsResultList,gtdResultsResultContext,gtdResultsResultAttached
syntax match gtdResultsResultKey /^\zs\d\{8}_\d\{6}/ contained conceal cchar=-
syntax match gtdResultsResultList / \zs!\S\+\ze / contained
syntax match gtdResultsResultContext / \zs@\S\+\ze / contained
...
highlight def link gtdResultsResultContext Directory
